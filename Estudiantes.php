...
<form class="d-flex" action="crud_estudiantes.php" method="post">
    <div class="col">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="txt_nombres" id="txt_nombres" class="form-control" placeholder="Daniel Alfonso" required>
        </div>

        <div class="mb-3">
            <label for="lbl_apellidos" class="form-label"><b>Apellidos</b></label>
            <input type="text" name="txt_apellidos" id="txt_apellidos" class="form-control" placeholder="Ruiz Barrios" required>
        </div>
        
        <div class="mb-3">
            <label for="lbl_direccion" class="form-label"><b>Direccion</b></label>
            <input type="text" name="txt_direccion" id="txt_direccion" class="form-control" placeholder="Calle del Hermano Pedro No.28" required>
        </div>
              
        <div class="mb-3">
            <label for="lbl_telefono" class="form-label"><b>Telefono</b></label>
            <input type="number" name="txt_telefono" id="txt_telefono" class="form-control" placeholder="5011 4975" required>
        </div>

        <div class="mb-3">
            <label for="lbl_correo" class="form-label"><b>Correo Electronico</b></label>
            <input type="text" name="txt_correo" id="txt_correo" class="form-control" placeholder="15danielru@gmail.com" required>
        </div>
...
<table class="table table-striped table-inverse table-responsive">
      <thead class="thead-inverse">
        ...
        <?php 
          include("datos_conexion.php");
          $db_conexion = mysqli_connect($db_host,$db_usr,$db_pass,$db_nombre);
          $db_conexion -> real_query ("SELECT e.id_estudiante as e.carne,e.nombres,e.apellidos,e.direccion,e.telefono,e.correo_electronico,p.genero,e.fecha_nacimiento,e.id_genero FROM estudiantes as e inner join genero as p on e.id_genero = p.id_genero;");
          $resultado = $db_conexion -> use_result();
          while ($fila = $resultado ->fetch_assoc()){
